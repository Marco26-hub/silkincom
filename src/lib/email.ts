...
export async function sendHeritageEmail(email: string) {
  const inner = `
    ...
    <p style="font-size:14px; line-height:1.75; color:#4A4A4A; margin:16px 0;">Nel 1400 le prime filande comasche iniziavano a tessere la fibra che avrebbe reso il Lago di Como il distretto serico più antico d'Europa.</p>
