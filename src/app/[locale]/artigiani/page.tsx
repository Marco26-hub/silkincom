...
export default async function ArtigianiPage() {
  ...
  const artisans = [
    {
      name: t('artisans.tintore.name'),
      role: t('artisans.tintore.role'),
      city: t('artisans.tintore.city'),
      image: '/artisans/tintore-tintoria-rocche-como.webp',
      alt: t('artisans.tintore.alt'),
      caption: t('artisans.tintore.caption'),
      story: t('artisans.tintore.story'),
    },
    {
      name: t('artisans.tessitore.name'),
      role: t('artisans.tessitore.role'),
      city: t('artisans.tessitore.city'),
      image: '/artisans/tessitore-tessitura-como.webp',
      alt: t('artisans.tessitore.alt'),
      caption: t('artisans.tessitore.caption'),
      story: t('artisans.tessitore.story'),
    },
    {
