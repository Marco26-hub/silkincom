...
- [x] **Nomi reali 3 artigiani** — Paolo (Maestro Tessitore, Cermenate), Adriano (Maestro Stampatore, Como), Roberta (Ricamatrice, Como) applicati a `messages/{it,en,es,fr,de,pt,nl}.json` artisans block + sezione "Le persone" del founder bio
